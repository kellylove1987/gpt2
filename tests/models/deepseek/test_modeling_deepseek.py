...
class DeepseekIntegrationTest(unittest.TestCase):
    def test_deepseek_batched_generation_sdpa(self):
        EXPECTED_TEXT = [
            "Mixture-of-experts is ",
            "DeepSeek is",
        ]
    ...
    def test_deepseek_batched_generation_eager(self):
        EXPECTED_TEXT = [
            "Mixture-of-experts is ",
            "DeepSeek is",
        ]
    ...
    @require_flash_attn
    @pytest.mark.flash_attn_test
    def test_deepseek_batched_generation_fa2(self):
        EXPECTED_TEXT = [
            "Mixture-of-experts is ",
            "DeepSeek is",
        ]
