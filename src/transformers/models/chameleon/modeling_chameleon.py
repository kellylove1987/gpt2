...
class ChameleonModel(ChameleonPreTrainedModel):
    ...
    def decode_image_tokens(self, bpe_tokens: torch.tensor):
        ...
        Args:
            bpe_tokens (`torch.tensor` of shape `(sequence_length)`):
        ...
        elif image_tensor.shape[0] > 1024:
            warnings.warn("Image tokens are longer than 1024 tokens. Truncating to 1024 tokens.")
            image_tensor = image_tensor[:1024]
